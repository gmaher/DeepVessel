...
from keras.layers import Conv3D, AveragePooling3D, UpSampling3D
...
def I2INet3D(input_shape=(64,64,64,1), output_channels=1, Nfilters=32, l2_reg=0.0):
    ...
    x = Conv3D(Nfilters, (3,3,3), padding='same',activation='relu')(x)
    x = Conv3D(Nfilters, (3,3,3), padding='same',activation='relu')(x)
    s_out_3 = Conv3D(output_channels, (1,1,1), padding='same',activation='sigmoid')(x)

    i2i = Model(inp,[s_out_3])
